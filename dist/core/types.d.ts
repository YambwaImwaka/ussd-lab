 ...
 */
export declare const END_SESSION: unique symbol;
 ...
 */
export type ScreenHandler = (input: string, session: Record<string, unknown>) => Promise<HandlerResult> | HandlerResult;
/**
